...
ALTER TABLE protean.provider_settings ADD COLUMN auto_assign_start TEXT NOT NULL DEFAULT '';
ALTER TABLE protean.provider_settings ADD COLUMN auto_assign_end   TEXT NOT NULL DEFAULT '';
