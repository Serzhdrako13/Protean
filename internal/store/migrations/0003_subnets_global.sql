...
ALTER TABLE wgpanel.subnets ALTER COLUMN provider SET DEFAULT '';

ALTER TABLE wgpanel.subnets DROP CONSTRAINT IF EXISTS subnets_provider_cidr_key;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE wgpanel.subnets ADD CONSTRAINT subnets_cidr_key UNIQUE (cidr);
    END IF;
END$$;
