...
func (m mobileConfigParams) build() []byte {
	...
	w(`      <key>PayloadIdentifier</key><string>com.protean.` + cn + `.credential</string>`)
	...
	w(`      <key>PayloadVersion</key><integer>1</integer>`)
	w(`      <key>PayloadIdentifier</key><string>com.protean.` + cn + `.vpn</string>`)
	...
	w(`  </array>`)
	w(`  <key>PayloadDisplayName</key><string>` + name + `</string>`)
	w(`  <key>PayloadIdentifier</key><string>com.protean.` + cn + `</string>`)
